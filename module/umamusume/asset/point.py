...
TEAM_STADIUM_OPPO_UP = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 360), "选择对手-上", None)
TEAM_STADIUM_OPPO_MID = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 640), "选择对手-中", None)
TEAM_STADIUM_OPPO_DOWN = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 900), "选择对手-下", None)
...
TEAM_STADIUM_RP_CANCEL = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(200, 830), "回复RP-否", None)
TEAM_STADIUM_RETURN = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(80, 1080), "返回", None)
TEAM_STADIUM_NEXT = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(410, 1180), "返回", None)

TO_TIME_SALE = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(500, 830), "前往限时特卖", None)
TIME_SALE_CLOSE = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 1080), "立即关闭", None)
TIME_SALE_CLOSE_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(520, 820), "重置确认", None)
TIME_SALE_RETURN = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(75, 1080), "返回", None)
TIME_SALE_ITEM_1 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 560), "限时特卖商品1", None)
TIME_SALE_ITEM_2 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 720), "限时特卖商品2", None)
TIME_SALE_ITEM_3 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 860), "限时特卖商品3", None)
TIME_SALE_ITEM_4 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 1000), "限时特卖商品4", None)
TIME_SALE_ITEM_5 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 810), "限时特卖商品5", None)
TIME_SALE_ITEM_6 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(600, 940), "限时特卖商品6", None)
TIME_SALE_BUY_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(510, 900), "兑换确认", None)
TIME_SALE_BUY_SUCCESS = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 830), "兑换成功", None)
TIME_SALE_COMMON_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 830), "限时特卖通用确认", None)
...
DONATE_ASK_4 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(500, 330), "请求-4", None)
DONATE_ASK_5 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(640, 330), "请求-5", None)
DONATE_ASK_SELECTED = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(520, 1180), "请求选择确认", None)
DONATE_ASK_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(520, 830), "请求确认", None)
DONATE_AVAILABLE_OFFER = ClickPoint(ClickPointType.CLICK_POINT_TYPE_TEMPLATE, BTN_DONATE_AVAILABLE, None, "前往捐赠请求", None)
DONATE_OFFER_PLUS = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(490, 700), "捐赠+1", None)
DONATE_OFFER_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(520, 920), "捐赠确认", None)
DONATE_COMMON_CONFIRM = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(360, 830), "捐赠通用确认", None)
