...
UI_CULTIVATE_CATCH_DOLL_GAME_3 = Template("CULTIVATE_CATCH_DOLL_GAME_3", UMAMUSUME_UI_TEMPLATE_PATH)
...
REF_RECOVER_TP_4 = Template("RECOVER_TP_4", UMAMUSUME_REF_TEMPLATE_PATH)
REF_RECOVER_TP_5 = Template("RECOVER_TP_5", UMAMUSUME_REF_TEMPLATE_PATH)
...
URA_DATE_3 = Template("URA_DATE_3", UMAMUSUME_REF_TEMPLATE_PATH)
...
UI_TEAM_STADIUM_RACE_1 = Template("TEAM_STADIUM_RACE", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_RACE_2 = Template("TEAM_STADIUM_RACE_TITLE", UMAMUSUME_UI_TEMPLATE_PATH)

UI_TEAM_STADIUM_TITLE = Template("TEAM_STADIUM_MAIN", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_MAIN_1 = Template("TEAM_STADIUM_TEAM_RACE", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_MAIN_2 = Template("TEAM_STADIUM_RANK_BONUS", UMAMUSUME_UI_TEMPLATE_PATH)

UI_TEAM_STADIUM_SELECT_OPPONENT = Template("TEAM_STADIUM_SELECT_OPPONENT", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_BEFORE_RACE = Template("TEAM_STADIUM_BEFORE_RACE", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_CHECK_RESULT = Template("TEAM_STADIUM_CHECK_RESULT", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_CHECK_ALL_RESULTS = Template("TEAM_STADIUM_CHECK_ALL_RESULTS", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_RESULTS = Template("TEAM_STADIUM_RESULTS", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_REWARD = Template("TEAM_STADIUM_REWARD", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_END = Template("TEAM_STADIUM_END", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_ALL_RESULTS = Template("TEAM_STADIUM_ALL_RESULTS", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_HIGH_SCORE = Template("TEAM_STADIUM_HIGH_SCORE", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_LEVEL = Template("TEAM_STADIUM_LEVEL", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TEAM_STADIUM_CONTINUE = Template("TEAM_STADIUM_CONTINUE", UMAMUSUME_UI_TEMPLATE_PATH)
REF_TEAM_STADIUM_OFF = Template("TEAM_STADIUM_OFF", UMAMUSUME_REF_TEMPLATE_PATH)
REF_TEAM_STADIUM_OFF2 = Template("TEAM_STADIUM_OFF_2", UMAMUSUME_REF_TEMPLATE_PATH)

UI_TIME_SALE_1 = Template("TIME_SALE_1", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TIME_SALE_2 = Template("TIME_SALE_2", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TIME_SALE_3 = Template("TIME_SALE_3", UMAMUSUME_UI_TEMPLATE_PATH)
REF_TIME_SALE_BOUGHT = Template("TIME_SALE_BOUGHT", UMAMUSUME_REF_TEMPLATE_PATH)

UI_GUILD_MAIN = Template("DONATE_GUILD_MAIN", UMAMUSUME_UI_TEMPLATE_PATH)
UI_GUILD_MAIN_2 = Template("DONATE_GUILD_MAIN_2", UMAMUSUME_UI_TEMPLATE_PATH)
REF_DONATE_REQUESTS = Template("DONATE_REQUESTS", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_PLUS_UNAVAILABLE = Template("DONATE_PLUS_UNAVAILABLE", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASKED = Template("DONATE_ASKED", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASKED_INCOMPLETE = Template("DONATE_ASKED_INCOMPLETE", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASKED_CLOSED = Template("REF_DONATE_ASKED_CLOSED", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASKED_TIMEOUT = Template("DONATE_ASKED_TIMEOUT", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASKING = Template("DONATE_ASKING", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_ASK_CONFIRM = Template("DONATE_ASK_CONFIRM", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DONATE_DONATED = Template("DONATE_DONATED", UMAMUSUME_REF_TEMPLATE_PATH)
BTN_DONATE_AVAILABLE = Template("DONATE_AVAILABLE", UMAMUSUME_BTN_TEMPLATE_PATH)
REF_DONATE_UNAVAILABLE = Template("DONATE_UNAVAILABLE", UMAMUSUME_REF_TEMPLATE_PATH)

UI_DAILY_RACE_TITLE = Template("DAILY_RACE_MAIN", UMAMUSUME_UI_TEMPLATE_PATH)
UI_DAILY_RACE_SELECT_RACER = Template("DAILY_RACE_SELECT_RACER", UMAMUSUME_UI_TEMPLATE_PATH)
REF_DAILY_RACE_MULTI_RACE_ON = Template("DAILY_RACE_MULTI_RACE_ON", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_MULTI_RACE_OFF = Template("DAILY_RACE_MULTI_RACE_OFF", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_MOONLIGHT = Template("DAILY_RACE_MOONLIGHT", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_JUPITER = Template("DAILY_RACE_JUPITER", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_EASY = Template("DAILY_RACE_EASY", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_NORMAL = Template("DAILY_RACE_NORMAL", UMAMUSUME_REF_TEMPLATE_PATH)
REF_DAILY_RACE_HARD = Template("DAILY_RACE_HARD", UMAMUSUME_REF_TEMPLATE_PATH)
