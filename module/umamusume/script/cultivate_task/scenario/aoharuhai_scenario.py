...
class AoharuHaiScenario(BaseScenario):
    ...
    def scenario_type(self) -> ScenarioType:
        return ScenarioType.SCENARIO_TYPE_AOHARU
    ...
    def parse_training_result(self, img: any, train_type) -> list[int]:
        # 使用数字ocr达到更高准确率
        sub_img_speed_incr = img[800:830, 30:140]
        sub_img_speed_incr = cv2.copyMakeBorder(sub_img_speed_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT, None,
                                                (255, 255, 255))
        ...
        sub_img_speed_incr_extra = cv2.copyMakeBorder(sub_img_speed_incr_extra, 20, 20, 20, 20, cv2.BORDER_CONSTANT,
                                                      None, (255, 255, 255))
        ...
        sub_img_stamina_incr = cv2.copyMakeBorder(sub_img_stamina_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT, None,
                                                  (255, 255, 255))
        ...
        sub_img_stamina_incr_extra = cv2.copyMakeBorder(sub_img_stamina_incr_extra, 20, 20, 20, 20, cv2.BORDER_CONSTANT,
                                                        None, (255, 255, 255))
        ...
        sub_img_power_incr = cv2.copyMakeBorder(sub_img_power_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT, None,
                                                (255, 255, 255))
        ...
        sub_img_power_incr_extra = cv2.copyMakeBorder(sub_img_power_incr_extra, 20, 20, 20, 20, cv2.BORDER_CONSTANT,
                                                      None, (255, 255, 255))
        ...
        sub_img_will_incr = cv2.copyMakeBorder(sub_img_will_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT, None,
                                               (255, 255, 255))
        ...
        sub_img_will_incr_extra = cv2.copyMakeBorder(sub_img_will_incr_extra, 20, 20, 20, 20, cv2.BORDER_CONSTANT, None,
                                                     (255, 255, 255))
        ...
        sub_img_intelligence_incr = cv2.copyMakeBorder(sub_img_intelligence_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT,
                                                       None, (255, 255, 255))
        ...
        sub_img_intelligence_incr_extra = cv2.copyMakeBorder(sub_img_intelligence_incr_extra, 20, 20, 20, 20,
        ...
        sub_img_skill_point_incr = cv2.copyMakeBorder(sub_img_skill_point_incr, 20, 20, 20, 20, cv2.BORDER_CONSTANT,
                                                      None, (255, 255, 255))
        ...
        sub_img_skill_point_incr_extra = cv2.copyMakeBorder(sub_img_skill_point_incr_extra, 20, 20, 20, 20,
                                                            cv2.BORDER_CONSTANT, None, (255, 255, 255))
        ...
        speed_icr = (0 if speed_incr_text == "" else int(speed_incr_text)) + (
            0 if speed_incr_extra_text == "" else int(speed_incr_extra_text))
        stamina_incr = (0 if stamina_incr_text == "" else int(stamina_incr_text)) + (
            0 if stamina_incr_extra_text == "" else int(stamina_incr_extra_text))
        power_incr = (0 if power_incr_text == "" else int(power_incr_text)) + (
            0 if power_incr_extra_text == "" else int(power_incr_extra_text))
        will_incr = (0 if will_incr_text == "" else int(will_incr_text)) + (
            0 if will_incr_extra_text == "" else int(will_incr_extra_text))
        intelligence_incr = (0 if intelligence_incr_text == "" else int(intelligence_incr_text)) + (
            0 if intelligence_incr_extra_text == "" else int(intelligence_incr_extra_text))
        skill_point_incr = (0 if skill_point_incr_text == "" else int(skill_point_incr_text)) + (
            0 if skill_point_incr_extra_text == "" else int(skill_point_incr_extra_text))
        ...
        failure_rate = 0 if failure_rate_text == "" else int(failure_rate_text)
        import random
        if failure_rate_text == '9':
            cv2.imwrite(
                './test/%d_%s_bingo%010d.png' % (train_type.value, failure_rate_text, random.randint(0, 9999999999)),
                sub_img_failure_rate)
        else:
            cv2.imwrite(
                './test/%d_%s_test%010d.png' % (train_type.value, failure_rate_text, random.randint(0, 9999999999)),
                sub_img_failure_rate)

        return [speed_icr, stamina_incr, power_incr, will_incr, intelligence_incr, skill_point_incr, failure_rate]
    ...
    def parse_training_support_card(self, img: any) -> list[SupportCardInfo]:
        ...
        for i in range(5):
            ...
            # 有青春杯训练, 且青春杯友情未满
            can_incr_aoharu_train = detect_aoharu_train_arrow(support_card_icon) and aoharu_train_not_full(
                support_card_icon)
