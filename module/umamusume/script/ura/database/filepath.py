...
FACTOR_IDS_FILEPATH = os.path.join(_LOCALAPPDATA,
                                   "UmamusumeResponseAnalyzer",
                                   "factor_ids.br")
SUPPORT_CARD_DATA_FILEPATH = os.path.join(_CURRENT,
                                          "support_card_data.br")
SUPPORT_CARD_EFFECT_TABLE_FILEPATH = os.path.join(_CURRENT,
                                                  "support_card_effect_table.br")
SUPPORT_CARD_UNIQUE_EFFECT_FILEPATH = os.path.join(_CURRENT,
                                                   "support_card_unique_effect.br")
CHARA_DATA_FILEPATH = os.path.join(_CURRENT,
                                   "chara_data.br")
CARD_DATA_FILEPATH = os.path.join(_CURRENT,
                                  "card_data.br")
TEXT_DATA_FILEPATH = os.path.join(_CURRENT, "text_data.br")
