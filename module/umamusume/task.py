...
class TaskDetail:
    ...
    def __setattr__(self, key, value):
        if key == "not_found_ui" or key == 'not_found_script':
...
class UmamusumeTaskType(Enum):
    ...
    UMAMUSUME_TASK_TYPE_DAILY_SCHEDULE = 4
...
def build_task(task_execute_mode: TaskExecuteMode, task_type: int,
    ...
    if task_type == 1:
        ...
        td.daily_legend_opponent = attachment_data['daily_legend_opponent']
    if task_type in (2, 4):
